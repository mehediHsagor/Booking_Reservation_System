    ...
    <div className="px-6 py-12 bg-gray-100 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
        ...
        <div className="space-y-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-gray-700">Connect with Us</h2>
            <div className="flex space-x-4 mt-2 aaaaa mx-7">
              <a href="#">
                <img className="w-10 h-10 mx-5 mt-2" src={gpsIcon} alt="GPS" />
              </a>
              <a href="#">
                <img className="w-10 h-10 mx-5 mt-2" src={emailIcon} alt="Email" />
              </a>
              <a href="#">
                <img className="w-10 h-10 mx-5 mt-2" src={phoneIcon} alt="Phone" />
              </a>
              <a href="#">
                <img className="w-10 h-10 mx-5 mt-2" src={facebookIcon} alt="Facebook" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 shadow-md rounded-lg">
          <h2 className="text-3xl font-bold text-gray-800 text-center mb-4">Contact </h2>
